...
import io.github.wouterbauweraerts.samples.springpetadoption.owners.internal.domain.OwnerFixtureBuilder;
...
class OwnerMapperTest {
    ...
    Stream<DynamicTest> map() {
        return Stream.of(
                null,
                anOwner(),
                OwnerFixtureBuilder.fixtureBuilder().ignoreName().build()
